...
class QuantESPCN_NearestNeighborResizeConv(nn.Module):
    ...
    def __init__(
            ...
            acc_bit_width: int = 32,
            weight_quant: WeightQuantType = CommonIntWeightPerChannelQuant):
        super(QuantESPCN_NearestNeighborResizeConv, self).__init__()
        self.upscale_factor = upscale_factor
...
def quant_espcn_nnrc(
        ...
        weight_quant: WeightQuantType = CommonIntWeightPerChannelQuant) -> QuantESPCN:
    """ """
    return QuantESPCN_NearestNeighborResizeConv(
        upscale_factor=upscale_factor,
        num_channels=num_channels,
        act_bit_width=act_bit_width,
        acc_bit_width=acc_bit_width,
